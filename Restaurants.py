...
def sortRestaurants():
	...
	data = []
	with open('C:/Users/tofor_000/Desktop/Cours_IIT/Data Mining/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json') as f:
		for line in f:
			data.append(json.loads(line))
	#print type(data[6])
	#json_obj = json.load(data)
	#print data
	output = open('C:/Users/tofor_000/Desktop/Restaurants_Reviews5.json','w')
